export const filterData = [
  {
    items: [
      ...
      { name: "Terminal de cuisson", value: "terminal-de-cuisson" },
      { name: "Boucherie", value: "boucherie" },
      { name: "Charcuterie", value: "charcuterie" },
      { name: "Bar - Tabac", value: "bar-tabac" },
      { name: "Coiffure", value: "coiffure" },
      { name: "Librairie - Papeterie", value: "librairie-papeterie" },
      { name: "Fleuriste", value: "Fleuriste" },
    ],
